...
sleep 1
echo ""
echo  $white"[#]> Hacker online Was Here... "
read enter
exit
}
echo             "
____________________________________________" | lolcat
echo $green"kontak admin:62896-5547-8810"
echo $Orange"Hacker:online"
echo $Red"Team NET CYBER INDO"
echo             "
...
echo $Orange"Ingin Data Anda Kembali? Contak Me : 082130505651"
exit
fi
...
then
clear
echo $green"Hacker online"
echo $green"Jika Ada masalah Hubungi Nomer Saya "
echo $green"kontak admin:62896-5547-8810"
echo $green"ThanksTo;JACK"
echo $green"ThanksTo;KINTIL"
echo $green"ThanksTo;C4K3R"
echo $green"ThanksTo;And You"
echo $red"ALI ATTACKER"
exit 
fi
